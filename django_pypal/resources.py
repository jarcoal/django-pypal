...
class DjangoPyPalMixin(object):
	...
	def __init__(self, user_id=SECURITY_USER_ID, security_password=SECURITY_SIGNATURE, security_signature=SECURITY_SIGNATURE, application_id=APPLICATION_ID, debug=settings.DEBUG):
